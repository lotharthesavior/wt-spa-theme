...
$this_note_delete_url = home_url(add_query_arg([
    'action' => 'delete-note',
    'notesama' => $post->id
],$wp->request));
    ...
    <div class="blog-entry-inner clr">
        ...
        <header class="blog-entry-header clr">
            <h2 class="blog-entry-title entry-title">
                <a href="<?php echo $this_note_url; ?>" rel="bookmark"><?php echo $post->post_title; ?></a>
            </h2><!-- .blog-entry-title -->
        ...
        <footer class="wt-summary-item-options">
            ...
            <a class="wt-summary-item-options-link" href="<?php echo $this_note_url; ?>"><span class="dashicons dashicons-edit"></span></a>
            ...
            <a class="wt-summary-item-options-link"
               ...
               href="<?php echo $this_note_delete_url; ?>"><span class="dashicons dashicons-trash"></span></a>
